...
if ([ $1 = "--init" ] && [ $2 = true ]); then
	...
	echo "Files downloaded and extracted successful!"
	chmod 777 train_setup.sh
	echo "Running train_setup..."
	echo "Mode [--init:true --env:dev --init-dav:true]"
	./train_setup.sh --init true --env dev --init-dav true
