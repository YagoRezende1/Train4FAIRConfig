...
if ([ $1 = "--init" ] && [ $2 = true ]); then
	...
	echo "Please wait..."
	sudo sshpass -p $DIG_OCEAN_DAV_PASS scp setup.tar.gz installation.tar.gz $DIG_OCEAN_DAV_USER@$DIG_OCEAN_DAV_HOST:/webdav/documentation/data/installation/development/localtotal/
